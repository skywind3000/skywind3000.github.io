...
按 Bram 前后几个关于高效使用 Vim的视频，大家每天需要花很多时间来编辑：代码、文档、邮件、日志 等等，除去这些外，还要分时间参加会议和人沟通，每个人的时间却都是不够的，优雅使用 Vim 无外乎：
...
![](http://skywind3000.github.com/word/images/vim-demo-2.png)
...
![](http://skywind3000.github.com/word/images/vim-demo-3.png)
...
![](http://skywind3000.github.com/word/images/vim-demo-4.png)
...
![](http://skywind3000.github.com/word/images/vim-demo-5.png)
...
磨刀不误砍柴工，熟练掌握 VimScript，熟读官方文档的情况下，坚持：“发现问题，找到更高效的方法，习惯化” 的三个循环，让我各处很工作变的优雅和流畅了那么一点点，使得心情更愉悦了。它的反面，错误的方法是：
